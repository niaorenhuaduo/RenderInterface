...
public:
	...
	////////////////////////////////////////////////////////////
	/// \brief Flip the world around the y-axis
	///
	////////////////////////////////////////////////////////////
	void SetYFlipping(bool bFlipping);
	...
	bool				GetYFlipping() const		{ return mbYFlipping; }
...
protected:
	...
	bool		mbYFlipping;		// Flips the world around the y-Axis
};
