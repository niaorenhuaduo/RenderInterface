...
public:
	...
	virtual void	VDrawPic(const RIVec4 &topleft, const RIVec4 &topright,
							 ...
							 const HTexture tex, 
							 guiOrder_t zord = RIGUIORD_FRONT,
							 bool bAlpha = false, 
	...
	virtual RITextureManager* GetTexMgr()=0;
protected:
	bool		mbRunning;
	U32			mWindowWidth;
	U32			mWindowHeight;
...
typedef class RIRenderInterface *PRIRENDERINTERFACE;
...
public:
	...
	virtual HTexture VGetTexture(const std::string &name)=0;	// chName: Path to the file relative to mFileDirectory
